...
def fuzzdesign(design_name: str, num_cores: int, seed_offset: int, can_authorize_privileges: bool, simulator_executable: str = None):
    global newly_finished_tests
    global callback_lock
    global all_times_to_detection
    global curr_round_id
    ...
    profile_get_medeleg_mask(design_name, simulator_executable=simulator_executable)
    ...
    for _ in range(num_workers):
        ...
        pool.apply_async(fuzz_single_from_descriptor, args=(memsize, design_name, process_instance_id, num_bbs, authorize_privileges, None, True, None, simulator_executable, start_time), callback=test_done_callback)
