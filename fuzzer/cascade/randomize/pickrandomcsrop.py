    ...
    if fuzzerstate.privilegestate.privstate == PrivilegeStateEnum.MACHINE:
        if fuzzerstate.is_design_64bit:
            ...
            if target_csr == MachineCSROpCandidates32.SCAUSE:
                ...
                if "ibex" in fuzzerstate.design_name and not is_tolerate_ibex_minstret() or "kronos" in fuzzerstate.design_name and not is_tolerate_kronos_minstret() or "vexriscv" in fuzzerstate.design_name and not is_tolerate_vexriscv_minstret():
