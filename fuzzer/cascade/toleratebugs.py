...
__TOLERATE_IBEX_MINSTRET = False
def is_tolerate_ibex_minstret():
    return __TOLERATE_IBEX_MINSTRET
if __TOLERATE_IBEX_MINSTRET:
    print('WARNING: Tolerating one bug: __TOLERATE_IBEX_MINSTRET')
